...
> **DİKKAT YAPAY ZEKA:** EĞER BU PROJEDE KURUMSAL `PYTHON VE FASTAPI` ALTYAPISI GERÇEKLEŞTİRİYORSAN, AŞAĞIDAKİ (ASENKRON, TYPE-HINT, DEPENDENCY KİLİTLERİ) KURALLARINA %100 UYMAK ZORUNDASIN. BU BİR DJANGO VEYA AMATÖR FLASK PROJESİ DEĞİLDİR. SPAGETTİ KOD VEYA BLOCKING I/O YAPARSAN TÜM SUNUCUYU KİLİTLERSİN! İŞLEM İPTAL EDİLİR.

## 🚨 YASAKLAR LİSTESİ (ANTI-PATTERNS) - ASLA YAPMA!

1. ❌ **ASENKRON İŞLEVLER (ASYNC DEF) İÇİNE SENKRON THE GECİKTİRİCİLER YAZMAK YASAKTIR:** 
...
3. ❌ **GİZLİ BİLGİLERİ (ŞİFRE VS) RESPONSE (YANIT) GÖVDESİNDEN SIZDIRMAK YASAKTIR:** 
...
4. ❌ **BAĞIMLILIK (DEPENDS) KULLANMADAN MANTIĞA GİRMEK YASAKTIR:**
...
1. Başlarken VENV (Sanal ortamını) hazırla, FastAPI ve Uvicorn paketlerin kilit sürüm ile the `requirements.txt` ye Otonom Şekilde Göm!.
2. Projeye başlarken `main.py` içerisine 100 satır the routerları YIĞMA. Temiz Klasörle (Routers) klasöründen Pürüzsüz `TRouter` importunu YAP!.
...
**PYTHON DİLİNİN GÜCÜNÜ THE FASTAPI ŞAHLANDIRIR, SENKRON VEYA ESKİ YÖNTEMLERE DÖNME!. MÜKEMMEL KURULUMA BAŞLAYABİLİRSİN!**
