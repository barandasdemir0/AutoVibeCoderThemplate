...
> **DİKKAT YAPAY ZEKA:** EĞER BU PROJEDE FRONTEND(REACT) İLE KOD YAZACAKSAN, DEVAM ATMADAN ÖNCE AŞAĞIDAKİ YAZILIM KANUNLARINI KODLARINA 1E1 ENTEGRE ETMEK ZORUNDASIN. BUNLARA UYACAĞINI ONAYLAMADAN ÜRETİME GEÇEMEZSİN. FRONTEND MANTIĞIN ÇÖP OLAMAZ.
...
4. ❌ **PROP DRILLING (ŞELALE) YAPMAK YASAKTIR:**
   Ana sayfadaki `user` objesini, oradan navbar'a, oradan profile, oradan avatar componenti ne kadar `<Avg user={user}/>` diye 5 kat aşağı TAŞIYAMAZSIN. Bunu yönetmek için `Zustand` gibi temiz global store kuracaksın. İhtiyacı olan bileşen dışarıya bağlı kalmadan direkt oradan çekecek.

5. ❌ **DONUK, BASİT MİNİMUM VİZYONLU (KÖTÜ) ARAYÜZ YASAĞI:**
...
/src
 ...
 ├── /features            # İŞTE BURASI ODAK: /users veya /auth adında açın,
...
**TAMAMEN PROFESYONEL VE CANLI BİR UYGULAMA SUN! BAŞLAYABİLİRSİN!**
